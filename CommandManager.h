...
enum eCommandNumber
{
	...
	COMMAND_SELECT			= 86,
	#if(MOCNAP == 1)
	COMMAND_SETMOCNAP = 87,
#endif
	#if(QUAEVENT == 1)
	COMMAND_SETQUATOP1 = 88,
	COMMAND_SETQUATOP2 = 89,
	COMMAND_SETQUATOP3 = 90,
#endif
	COMMAND_STARTBSV = 115,
	//tue add Bom Mau//////
	COMMAND_AUTOHP = 93,
	COMMAND_ADDBUFF = 94,
	//////////////////////
...
#endif
	#if(QUAEVENT == 1)
	bool CommandSetQuaTop1(LPOBJ lpObj, char* arg);
	bool CommandSetQuaTop2(LPOBJ lpObj, char* arg);
	bool CommandSetQuaTop3(LPOBJ lpObj, char* arg);
#endif
	void CommandMonsterCall(LPOBJ lpObj, char* arg);
	bool CommandSelectSub(LPOBJ lpObj,char* arg);
