...
// -------------------------------------------------------------------------------
void SachThuocTinh::SachThuocTinh_Option(LPOBJ lpObj, bool flag)
{
	if (flag != 0)
	{
		return;
	...
	if (lpObj->SACHTHUOCTINH.SACHTHUOCTINH_04 >= this->OPTION_LEVEL_05)
	{
		...
		{
			lpObj->PhysiDamageMinLeft += this->OPTION_ACTIVE_05;	 //	Sát Thương
			lpObj->PhysiDamageMinRight += this->OPTION_ACTIVE_05; //	Sát Thương
			lpObj->PhysiDamageMaxLeft += this->OPTION_ACTIVE_05;	 //	Sát Thương
			lpObj->PhysiDamageMaxRight += this->OPTION_ACTIVE_05; //	Sát Thương

			lpObj->MagicDamageMax += this->OPTION_ACTIVE_05;		 //	 Sát thương phép thuật
			lpObj->CurseDamageMax += this->OPTION_ACTIVE_05;		 //	 Sát thương phép thuật
			//==================================================
		}
