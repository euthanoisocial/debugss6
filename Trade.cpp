...
void CTrade::CGTradeOkButtonRecv(PMSG_TRADE_OK_BUTTON_RECV* lpMsg,int aIndex) // OK
{
	...
	if (lpObj->RPSMode >= 1 && lpTarget->RPSMode == 0)
	{
		...
		gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(550), lpObj->Name);
		return;
	}
	if (lpTarget->RPSMode >= 1 && lpObj->RPSMode == 0)
	{
		...
		this->ResetTrade(bIndex);
		this->GCTradeResultSend(bIndex, 0);
		gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(550), lpTarget->Name);
		return;
	}
	if (lpObj->RPSMode >= 1 || lpTarget->RPSMode >= 1)
	{
		if (lpObj->RPSMode == lpTarget->RPSMode || lpTarget->RPSMode == lpObj->RPSMode)
		{
			...
			gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(543));
		}
		...
		if (lpObj->RPSMode == 3 && lpTarget->RPSMode == 1 || lpObj->RPSMode == 2 && lpTarget->RPSMode == 3 || lpObj->RPSMode == 1 && lpTarget->RPSMode == 2)
		{
			...
			//
			PostMessageUserON(lpTarget->Name, gMessage.GetMessage(542));
			//
			if (lpObj->RPSMode == 3 && lpTarget->RPSMode == 1)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(544), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(545), lpObj->Name);
			}
			if (lpObj->RPSMode == 2 && lpTarget->RPSMode == 3)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(546), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(547), lpObj->Name);
			}
			if (lpObj->RPSMode == 1 && lpTarget->RPSMode == 2)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(548), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(549), lpObj->Name);
			}
		}
		...
		if (lpTarget->RPSMode == 1 && lpObj->RPSMode == 2 || lpTarget->RPSMode == 2 && lpObj->RPSMode == 3 || lpTarget->RPSMode == 3 && lpObj->RPSMode == 1)
		{
			...
			//
			PostMessageUserON(lpObj->Name, gMessage.GetMessage(542));
			//
			if (lpTarget->RPSMode == 3 && lpObj->RPSMode == 11)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(545), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(544), lpObj->Name);
			}
			if (lpTarget->RPSMode == 2 && lpObj->RPSMode == 3)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(547), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(546), lpObj->Name);
			}
			if (lpTarget->RPSMode == 1 && lpObj->RPSMode == 2)
			{
				gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(549), lpTarget->Name);
				gNotice.GCNoticeSend(bIndex, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(548), lpObj->Name);
			}
		}
	}
