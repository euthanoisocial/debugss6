...
int VuKhiRong::CountItem(LPOBJ lpObj, int level)
{
	...
	if (  lpObj->Inventory[0].m_Index == GET_ITEM(0,19)
		...
		||lpObj->Inventory[0].m_Index == GET_ITEM(0,56)
		||lpObj->Inventory[0].m_Index == GET_ITEM(0,105)
		||lpObj->Inventory[0].m_Index == GET_ITEM(0,106)
		||lpObj->Inventory[0].m_Index == GET_ITEM(0,110)
		||lpObj->Inventory[0].m_Index == GET_ITEM(2,13)
		||lpObj->Inventory[0].m_Index == GET_ITEM(2,25)
		||lpObj->Inventory[0].m_Index == GET_ITEM(2,31)
		||lpObj->Inventory[0].m_Index == GET_ITEM(4,18)
		||lpObj->Inventory[0].m_Index == GET_ITEM(4,30)
		||lpObj->Inventory[0].m_Index == GET_ITEM(4,33)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,10)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,49)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,65)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,36)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,50)
		||lpObj->Inventory[0].m_Index == GET_ITEM(5,66)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,19)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,51)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,56)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,105)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,106)
		||lpObj->Inventory[1].m_Index == GET_ITEM(0,110)
		||lpObj->Inventory[1].m_Index == GET_ITEM(2,13)
		||lpObj->Inventory[1].m_Index == GET_ITEM(2,25)
		||lpObj->Inventory[1].m_Index == GET_ITEM(2,31)
		||lpObj->Inventory[1].m_Index == GET_ITEM(4,18)
		||lpObj->Inventory[1].m_Index == GET_ITEM(4,30)
		||lpObj->Inventory[1].m_Index == GET_ITEM(4,33)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,10)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,49)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,65)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,36)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,50)
		||lpObj->Inventory[1].m_Index == GET_ITEM(5,66)
		)
	{
