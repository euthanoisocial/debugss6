...
enum eSkillNumber
{
	...
	SKILL_FIRE_BALL = 4,
	SKILL_FLAME = 5,
	SKILL_TELEPORT = 6, // phép dịch chuyển
	SKILL_ICE = 7,
	SKILL_TWISTER = 8,
	SKILL_EVIL_SPIRIT = 9,
	SKILL_HELL_FIRE = 10,
	...
	SKILL_SUMMON7 = 36,
	SKILL_DECAY = 38,
	SKILL_ICE_STORM = 39,  // Mưa sao băng
	SKILL_NOVA = 40, // Nova
	SKILL_TWISTING_SLASH = 41, // Xoay Kiếm
	SKILL_RAGEFUL_BLOW = 42, // Địa Chấn
	SKILL_DEATH_STAB = 43, // Đâm Gió
...
public:
	...
	bool SkillDWTEST(int aIndex,int bIndex,CSkill* lpSkill,BYTE x,BYTE y,bool combo);
	bool CheckSpamSkill(int aIndex, int SkillIndex, int Type);
