...
public:
	CServerInfo();
	virtual ~CServerInfo();
	void SendServerInfo(int aIndex);
	void ReadInit();
...
public:
	...
	int m_PartyDivideZen;
	int m_CreateCoinWhenZenIsMax[MAX_ACCOUNT_LEVEL];
	int m_CreateCoinIndex;
	int m_CreateCoinPrice;
	...
	int SkillDocDW;
	//int m_MoGioiHanDameQuai;
		///buff efl
	 int m_SatThuongVatLy;
	 int m_SatThuongPhep;
	 int m_LoiNguyen;
	 int m_PhongThu;
     int m_CritDamageDL;
	...
	int m_GensExitTime[MAX_ACCOUNT_LEVEL];
	int m_GensSystemSelfGensDamage;
	int m_HelperSwitch;
	...
	int CommandRelife_Level;
	int CommandRelife_Reset;

	int CommandRelife_ResetLife;
	int CommandRelife_Point;

	int CommandRelife_Max;
	...
	BYTE NewItemDrop[6];
	BYTE NewVKDrop[6];
	BYTE NewPhuKienDrop[6];
	BYTE m_CheckOptionsDrop;
	BYTE m_OptionPecent;
	BYTE m_SkillPecent;
	BYTE m_LuckPecent;
	int m_timedongbang; 
